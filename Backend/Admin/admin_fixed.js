    ...
    try {
      ...
      const safeCount = async (collectionName) => {
        try {
          ...
          console.log(`Error counting ${collectionName}:`, err.message);
          return 0;
        }
      };
      ...
      const safeFind = async (collectionName, query = {}, options = {}) => {
        try {
          ...
          console.log(`Error finding ${collectionName}:`, err.message);
          return [];
        }
      };
      ...
      const safeAggregate = async (collectionName, pipeline) => {
        try {
          ...
          console.log(`Error aggregating ${collectionName}:`, err.message);
          return [];
        }
      };
