    ...
    return (
      <div className="min-h-screen bg-[#f9f3ea]">
        ...
        <main className="container mx-auto py-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
            {/* Contact Information */}
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span>kedar Business Hub Katargam Ved Road Surat Gujarat</span>
                  </div>
                </div>
